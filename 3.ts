namespace Tareas3 {
    ...
    function mostrarTareasPorPersona(tareas: Tarea[], persona: Persona): Promise<Tarea[]> {
        return new Promise((resolve) => {
            setTimeout(() => {
                const tareasPorPersona = tareas.filter(tarea => tarea.Asignado === persona.nombre);
    ...
    async function executeTareas() {
        ...
        const r1 = await mostrarTareasPorPersona(testTareas, testPersonas[0]);
        console.log(r1)
